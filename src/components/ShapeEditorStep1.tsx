...
const bindP1 = useGesture({
  ...
  return (
    <div>
      ...
      <p>여기에 구현하세요!</p>
      {/* svg 내에서 path 사용이 가능 */}
      <svg width="500px" height="500px" style={{border: '1px solid #111',backgroundColor:"#fff"}} >
        <path 
          d={drawPath(stroke)} 
          fill="none"
          stroke={stroke.color}
        ...
        />
        <path d={drawCircle(6,stroke.p0.x,stroke.p0.y)} fill='#fff' stroke='#111' strokeWidth={"2px"} {...bindP0()} />
        <path d={drawCircle(6,stroke.p1.x,stroke.p1.y)} fill='#fff' stroke='#111' strokeWidth={"2px"}  {...bindP1()} />
